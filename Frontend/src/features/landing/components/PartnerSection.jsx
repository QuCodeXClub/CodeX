          ...
          {partners.list.map((org, index) => (
            ...
            >
              ...
              <div className="mt-auto pt-4 border-t border-border-soft/50 flex justify-between items-center relative z-10">
                ...
                <div className="w-8 h-8 rounded-full bg-accent/10 flex items-center justify-center text-accent group-hover:bg-accent group-hover:text-bg group-hover:shadow-[0_0_10px_rgba(46,197,212,0.5)] transition-all duration-500">
