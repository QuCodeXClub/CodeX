  ...
  return (
    <div className="flex flex-col gap-10">
        ...
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="font-sans text-sm uppercase tracking-widest font-bold">Event Highlights</h3>
        </div>
        ...
        <div className="bg-panel rounded-2xl p-6 md:p-8 text-white shadow-2xl relative overflow-hidden border border-white/10">
          ...
          <div className="grid grid-cols-3 gap-4 border-b border-white/10 pb-6 mb-6">
            <div>
              ...
              <p className="text-[0.6rem] font-mono text-white/50 uppercase tracking-widest">Participants</p>
            </div>
            <div>
              <p className="font-sans text-2xl font-bold">80+</p>
              <p className="text-[0.6rem] font-mono text-white/50 uppercase tracking-widest">Projects</p>
            </div>
            <div>
              <p className="font-sans text-2xl font-bold">2</p>
              <p className="text-[0.6rem] font-mono text-white/50 uppercase tracking-widest">Days</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-4 gap-2 text-center bg-black/40 rounded-xl p-4 border border-white/5">
            <div>
              ...
              <p className="text-[0.55rem] font-mono text-white/40 uppercase tracking-widest">Days</p>
            </div>
            <div>
              <p className="font-sans text-xl">14</p>
              <p className="text-[0.55rem] font-mono text-white/40 uppercase tracking-widest">Hrs</p>
            </div>
            <div>
              <p className="font-sans text-xl">37</p>
              <p className="text-[0.55rem] font-mono text-white/40 uppercase tracking-widest">Mins</p>
            </div>
            <div>
              <p className="font-sans text-xl text-accent">59</p>
              <p className="text-[0.55rem] font-mono text-white/40 uppercase tracking-widest text-accent/50">Secs</p>
            </div>
          </div>
        </div>
      </div>
      <div className="bg-white/40 backdrop-blur-md rounded-2xl p-6 border border-line shadow-sm">
        <div className="flex gap-4 mb-5">
          ...
          <div>
            <h4 className="font-sans text-lg uppercase tracking-wide">Stay In The Loop</h4>
      ...
      <div>
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="font-sans text-sm uppercase tracking-widest font-bold">Past Events</h3>
        </div>
                <div className="grid grid-cols-4 gap-2 mb-4">
          {[1, 2, 3, 4].map((i) => (
            <div key={i} className="aspect-square bg-panel rounded-lg overflow-hidden relative group cursor-pointer">
