...
- **[Image Guidelines](./image-guidelines.md)**: Guidelines for frontend image storage, Cloudinary usage, `.webp` formatting, optimization, and interactive image zoom (`useImageZoom`).
